...
public:
  ...
  IGL_INLINE void draw(ViewerData& data, bool update_matrices = true, bool oculusVR = false, Eigen::Matrix4f& view_ = Eigen::Matrix4f(), Eigen::Matrix4f& proj_ = Eigen::Matrix4f());
